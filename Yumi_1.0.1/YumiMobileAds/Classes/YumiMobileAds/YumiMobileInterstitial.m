...
- (void)setUpUI {
    // close button
    NSString *path = [[[YumiMobileTools sharedTool] returnMainBundle] pathForResource:@"yumi_close" ofType:@"png"];
...
- (void)setUpInterstitialMaterial {
    ...
    NSString *htmlPath = [[[YumiMobileTools sharedTool] returnMainBundle] pathForResource:resourceName ofType:@"html"];
    NSString *logoPath = [[[YumiMobileTools sharedTool] returnMainBundle] pathForResource:@"logo" ofType:@"html"];
