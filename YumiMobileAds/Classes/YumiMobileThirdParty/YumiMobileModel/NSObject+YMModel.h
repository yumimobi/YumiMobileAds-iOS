 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `YMModel` protocol for custom methods.


 Sample Code:

     ********************** json convertor *********************
     @interfaceClass YMAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation YMAuthor
     @end

     @interfaceClass YMBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) YMAuthor *author;
     @end
     @implementation YMBook
     @end
 ...
 {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
     ...
     ********************** Coding/Copying/hash/equal *********************
     @interfaceClass YMShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
 ...
 */
@interface NSDictionary (YMModel)
...
/**
 ...
 There's no need to add '<YMModel>' to your class header.
 */
@protocol YMModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @interfaceClass YMShadow, YMBorder, YMAttachment;

        @interfaceClass YMAttributes
        @property NSString *name;
        ...
        @implementation YMAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [YMShadow class],
                     @"borders" : YMBorder.class,
                     @"attachments" : @"YMAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @interfaceClass YMCircle, YMRectangle, YMLine;

        @implementation YMShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [YMCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [YMRectangle class];
